...
class Window(QWidget):
    def __init__(self):
        ...
        QListWidgetItem(QIcon('html.png'), "HTLM", self.myListWidget2)
        QListWidgetItem(QIcon('css.png'), "CSS", self.myListWidget2)
        QListWidgetItem(QIcon('javascript.png'), "Javascript", self.myListWidget2)
